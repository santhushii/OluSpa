...
export default function Footer({ branding, contact, footer }: Props) {
  return (
    <footer className="relative overflow-hidden border-t border-olu-beige/60 bg-olu-cream">
      ...
      <div className="relative mx-auto max-w-container px-4 pt-20 pb-12 text-olu-body">
        <div className="grid gap-12 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)_minmax(0,1fr)] lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)_minmax(0,1fr)]">
          {/* Left Column - Address & Logo */}
          <div className="flex flex-col items-center gap-6 text-center md:items-start md:text-left">
            <img 
              src={branding.footerLogo} 
              alt="OLU Ayurveda Beach" 
              className="h-24 w-auto md:h-28 mb-2"
            />
            <div className="flex flex-col items-center md:items-start gap-3">
              <div className="flex items-center gap-3 text-sm text-olu-body/80">
                <span className="inline-flex h-10 w-10 items-center justify-center rounded-full border-2 border-olu-green/30 bg-olu-green/5 text-lg text-olu-green flex-shrink-0">
                  ⌖
                </span>
          ...
          <div className="flex flex-col items-center gap-5 text-center md:items-center">
            <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-olu-ink mb-2">Contact Info</h3>
          ...
          <div className="flex flex-col items-center gap-5 text-center md:items-end md:text-right">
            <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-olu-ink mb-2">Follow Us On</h3>
        ...
        {/* Partners & Copyright */}
        <div className="mt-16 pt-8 border-t border-olu-beige/60 flex flex-col items-center gap-6 text-center">
          ...
          <p className="max-w-3xl text-xs normal-case tracking-normal text-olu-body/60 leading-relaxed">
            {footer.note}
          </p>
        </div>
      </div>
